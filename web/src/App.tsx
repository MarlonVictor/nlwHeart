...
import { LazyAnimation } from './components/AnimateComponent'
...
function App() {
    ...
    return (
        <>
            ...
            <main id="Main" className="bg-home-background pt-40 sm:pt-0 sm:h-screen transform -translate-y-12 flex justify-center items-center mt-14 mx-auto md:max-w-3xl lg:max-w-5xl">
                <LazyAnimation className="hidden sm:block w-52 md:w-auto lg:w-96 xl:flex-1">
                    <img 
                        src={HomeImage} 
                        alt="DoWhile" 
                        className="lg:w-96"
            ...
            <section id="Form" className="bg-opinions-background bg-cover md:px-10 lg:px-0">
                <div className="flex flex-col md:flex-row justify-between items-center lg:px-0 lg:max-w-5xl mx-auto h-screen">
                    <LazyAnimation className="md:w-96 md:mr-10 lg:w-3/6 xl:w-2/5 px-10 pt-16 md:px-0">
            ...
            <section id="Methods" className="lg:h-screen my-10 lg:my-0 sm:mx-10 lg:mx-auto lg:max-w-5xl flex flex-col justify-center">
                <LazyAnimation className="flex justify-between">
                ...
                <LazyAnimation className="grid md:grid-cols-2 lg:grid-cols-3 mt-16 lg:mt-28 gap-3 mx-5 sm:mx-0">
